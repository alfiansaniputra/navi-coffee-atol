                ...
                <ul class="side-menu metismenu">
                    <li class="heading">Menu</li>
                        <li class="{{ (request()->is('admin/dashboard*')) ? 'active' : '' }}">
                            <a href="{{route('admin.index')}}"><i class="sidebar-item-icon ti-dashboard"></i>
                        ...
                        <li class="{{ (request()->is('admin/pembelian*')) ? 'active' : '' }}">
                            <a href="{{url('admin/pembelian')}}"><i class="sidebar-item-icon ti-shopping-cart-full"></i>
                                <span class="nav-label">Pembelian</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('admin/pembayaran*')) ? 'active' : '' }}">
                            <a href="{{url('admin/pembayaran')}}"><i class="sidebar-item-icon ti-credit-card"></i>
                                <span class="nav-label">Pembayaran</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('admin/akun*')) ? 'active' : '' }}">
                            <a href="{{url('admin/akun')}}"><i class="sidebar-item-icon ti-id-badge"></i>
                                <span class="nav-label">akun</span>
                            </a>
                        </li>
                    <li class="heading">Data Internal Toko</li>
                        <li class="{{ (request()->is('admin/kopi*')) ? 'active' : '' }}">
                            <a href="{{route('admin.kopi')}}"><i class="sidebar-item-icon ti-cup"></i>
                        ...
                        <li class="{{ (request()->is('admin/bahanbaku*')) ? 'active' : '' }}">
                            <a href="{{url('admin/bahanbaku')}}"><i class="sidebar-item-icon ti-bar-chart-alt"></i>
