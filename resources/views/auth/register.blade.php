    ...
    <div style="max-width: 400px;margin: 100px auto 50px;">
        ...
        <div class="ibox login-box">
            <form class="ibox-body" id="login-form" method="POST" action="{{ route('register') }}">
                @csrf
                <h4 class="font-strong text-center mb-5">Registrasi Akun</h4>
                <div class="form-group mb-4">
                    <input class="form-control form-control-line @error('name') is-invalid @enderror" type="text" name="name" placeholder="Nama Lengkap" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="form-group mb-4">
                    <input class="form-control form-control-line" id="password-confirm" type="password" name="password_confirmation" placeholder="Konfirmasi Password" autocomplete="new-password">
                </div>
                <!-- <div class="flexbox mb-5">
                    ...
                    <div class="text-center mb-4">
                        <button class="btn btn-primary btn-rounded btn-block">Registrasi Akun</button>
                        <div class="cow pt-2">
