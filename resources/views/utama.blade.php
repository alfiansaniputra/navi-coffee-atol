					...
					<div class="col-lg-4 col-6 div-produk">
							<div class="single-menu">
								...
								<p>
									...
									<center>
									<a href="{{ url('add-to-cart/'.$kopi->id) }}" class="genric-btn primary circle mr-3" id="btn-resep">Beli</a>
									</center>
								<!-- <div class="d-flex justify-content-center mt-3">
									<a href="kandungangizi.html" class="genric-btn primary-border circle">Kandungan Gizi</a>
								</div> -->
							</div>
						</div>
@endforeach
