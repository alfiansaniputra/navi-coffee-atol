...
<form action="{{url('admin/suplier')}}/{{$suplier->id}}" method="post">
    <div class="form-group mb-4">
        <label>Nama suplier</label>
        <input class="form-control" type="text"  placeholder="Nama suplier" name="nama_perusahaan" value="{{ $suplier['nama_perusahaan']}}" required>
    </div>
    <div class="form-group mb-4">
        <label>No HP suplier</label>
        <input class="form-control" type="number"  placeholder="No HP suplier" name="no_hp" value="{{ $suplier['no_hp']}}" required>
    </div>
    <div class="form-group mb-4">
        <label>Alamat suplier</label>
        <textarea class="form-control" type="text"  placeholder="Alamat suplier" name="alamat" required name="" id="" cols="30" rows="4">{{ $suplier['alamat']}}</textarea>
    </div>
<div class="row">
    <div class="col-6">
        <div class="form-group mb-4">
...
<script>
    ...
    const provinceId = "{!! $suplier['provinsi'] ? $suplier['provinsi'] : 0 !!}" ;
    const districtId = "{!! $suplier['kota'] ? $suplier['kota'] : 0 !!}" ;
