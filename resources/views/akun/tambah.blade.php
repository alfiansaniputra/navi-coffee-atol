...
@endif
<form class="" action="{{route('admin.akun-tambah')}}" method="post" enctype="multipart/form-data">
    <div class="form-group mb-4">
        <label>Role <span class="text-danger">*</span></label>
        <div class="">
            <select name="role"  class="form-control" required>
                <option value="admin" name="role" >Admin</option>
                <option value="pelanggan" name="role" >Pelanggan</option>
            </select>
        </div>
    </div>
    <div class="form-group mb-4">
    ...
    <div class="form-group mb-4">
        ...
        <input class="form-control" type="number"  placeholder="No HP" name="no_hp" required>
    </div>
    <div class="form-group mb-4">
        <label>Alamat Lengkap</label>
        <textarea class="form-control" type="text"  placeholder="Alamat" name="alamat" required name="" id="" cols="30" rows="4"></textarea>
    </div>
    <div class="row">
        <div class="col-6">
            <div class="form-group mb-4">
    ...
    <div class="form-group mb-4">
        ...
        <input class="form-control" type="number"  placeholder="Kode Pos" name="kodepos" required>
    </div>
